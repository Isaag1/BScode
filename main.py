...
def info() -> typing.Dict:
  ...
  return {
    ...
    "color": "#ffd1f5",  # TODO: Choose color
...
def move(game_state: typing.Dict) -> typing.Dict:
  ...
  for part in my_body[1:]:
    if my_head['x'] == part['x'] and my_head['y'] == part['y']:
      is_move_safe['up'] = False
      is_move_safe['down'] = False
      is_move_safe['left'] = False
      is_move_safe['right'] = False
  ...
  for snake in opponents:
    for part in snake['body']:
      if abs(part['x'] - my_head['x']) + abs(part['y'] - my_head['y']) == 1:
        if part['x'] < my_head['x']:
          is_move_safe['left'] = False
        elif part['x'] > my_head['x']:
          is_move_safe['right'] = False
        elif part['y'] < my_head['y']:
          is_move_safe['down'] = False
        elif part['y'] > my_head['y']:
          is_move_safe['up'] = False
  safe_moves = []
  ...
  if food:
    ...
    for f in food:
      ...
      closest_food = food[distances.index(min(distances))]
